...
const nets = [
  { category: "Sport Netting & Children's Nets", title: 'Batting Cages', img: '/images/optimized/service-09-760.jpg', desc: 'Whether you need a single cage for your home or multiple cages for an entertainment center we can help you build what you need, or replace existing damaged nets.' },
  { category: "Sport Netting & Children's Nets", title: "Obstacle Courses & Kid's Climbs", img: '/images/optimized/service-01-760.jpg', desc: "Nets Unlimited, Inc. can also create and install the netting for any of your kid's climbs and obstacle course needs, either at your home or business." },
  { category: "Sport Netting & Children's Nets", title: 'Sport Court Containment', img: '/images/optimized/service-06-760.jpg', desc: "Do you have a sports court that needs barriers so the balls stay in the court? We can customize containment netting to keep those balls in play and out of the neighbor's yard." },
  { category: 'Aviaries, Pet Protection, & Shade', title: 'Aviaries', img: '/images/optimized/service-03-760.jpg', desc: 'Do you have a special bird that deserves more than an ordinary cage? We can help.' },
  { category: 'Aviaries, Pet Protection, & Shade', title: 'Pet Netting Protection', img: '/images/optimized/service-08-760.jpg', desc: 'Do you have an animal that you need to protect from predators like coyotes or hawks, or do you simply need to keep your pet in your yard? We can do that too.' },
  { category: 'Aviaries, Pet Protection, & Shade', title: 'Shade Structures', img: '/images/optimized/service-02-760.jpg', desc: 'Nets Unlimited Inc. can provide shade structures for outdoor patios, pools, seating areas, pathways, and more.' },
  { category: 'Themeing, Thatch, & Decor', title: 'Handrails', img: '/images/optimized/service-04-760.jpg', desc: 'We can add decorative and functional handrails anywhere that you may need them. Nets Unlimited Inc. has installed handrail nets around patios, raised decks, walkways, boardwalks, and more.' },
  { category: 'Themeing, Thatch, & Decor', title: 'Bridges & Tunnels', img: '/images/optimized/service-05-760.jpg', desc: 'Nets Unlimited Inc. has created hundreds of bridges and tunnels over the years, we can install them for decor, or truly functional bridges hundreds of feet in the air.' },
  { category: 'Themeing, Thatch, & Decor', title: 'Thatch Umbrellas & Cabanas', img: '/images/optimized/service-07-760.jpg', desc: 'Do you need a shade umbrella or cabana, but want something different than everyone else? Let us help you build a perfect patio oasis with natural or artificial thatch.' },
]
